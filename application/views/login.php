...
<head>
  ...
  <title>Login E-Ticbat | Electronic Ticketing Persibat</title>
...
<body class="red darken-1">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row">
          <div class="input-field col s12">
              <button type="submit" class="btn waves-effect red darken-1 col s12">Login</button>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12 m12 l6">
              <p class="margin right-align medium-small"><a href="<?= site_url() ?>login/lupapassword">Lupa Password ?</a></p>
          </div>          
        </div>
