...
<head>
  ...
  <title>Halaman Tidak Ditemukan | Electronic Ticketing Persibat</title>
    ...
    <div class="col s12 z-depth-4 card-panel">
        ...
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text">Halaman Tidak Ditemukan :(</p>
          </div>
        </div>
        <div class="row">
          <div class="center">
              <p class="margin right-align medium-small"><a href="<?= site_url() ?>login">Kembali</a></p>
          </div>          
        </div>
