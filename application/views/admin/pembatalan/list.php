...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('.dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('admin/pembatalan/listdata') ?>",
                "type": "POST"
            },
    ...
    function bukti(id)
    {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/pembatalan/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="waktu_upload"]').val(data.waktu_upload);
    ...
    function kirim()
    {
        ...
        var url;
        url = "<?php echo site_url('admin/pembatalan/kirim') ?>";
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="no_hp" readonly="" class="form-control" type="text" value="">
                                    <span class="form-bar"></span>
                        ...
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    ...
                                    <span class="form-bar"></span>
                                    <label class="float-label">Waktu Pemesanan</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="material-group material-group-danger">
                                ...
                                <div class="form-group form-danger form-static-label">
                                    <input name="waktu_upload" readonly="" class="form-control" type="text" value="">
                                    <span class="form-bar"></span>
                                    <label class="float-label">Waktu Upload</label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary waves-effect waves-light" id="btnkirim" onclick="kirim()">Konfirmasi</button>
            </div>
        </div>
    </div>
</div>