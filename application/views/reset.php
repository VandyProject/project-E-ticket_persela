...
<head>
  ...
  <title>Setting Password Baru | Electronic Ticketing Persibat</title>
...
<body class="red darken-1">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
        <form class="login-form" method="POST" action="<?= site_url() ?>login/resetvalidasi">
        <div class="row">
          <div class="input-field col s12 center">
            <img src="<?= base_url() ?>assets/admin/images/login-logo.png" alt="" class="circle responsive-img valign profile-image-login">
            <p class="center login-form-text">Setting Password Baru</p>
          </div>
        </div>
        ...
        <div class="row margin">
          ...
          <div class="input-field col s12">
            ...
            <label for="p2">Konfirmasi Password</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
              <button type="submit" class="btn waves-effect red darken-1 col s12">Reset</button>
          </div>
        </div>
        <div class="row">
