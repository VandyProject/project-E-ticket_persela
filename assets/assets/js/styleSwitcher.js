...
(function ($) {
    ...
    var mainAppNew = {
        ...
        main_fun: function () {
            ...
            $('#pink').click(function () {
                $('#mainCSS').attr('href', 'assets/assets/css/themes/pink.css');
            });
            $('#green').click(function () {
                $('#mainCSS').attr('href', 'assets/assets/css/themes/green.css');
            });
            $('#blue').click(function () {
                $('#mainCSS').attr('href', 'assets/assets/css/themes/blue.css');
            });
            $('#brown').click(function () {
                $('#mainCSS').attr('href', 'assets/assets/css/themes/brown.css');
            });
